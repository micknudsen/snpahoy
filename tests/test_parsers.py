...
from snpahoy.parsers import parse_bed_input


class TestParsers(unittest.TestCase):

    def test_parse_bed_input(self):

        bed_file_lines = ['\t'.join(['chr1', '1000', '1001']),
                          '\t'.join(['chr2', '5000', '5001']),
                          '\t'.join(['chr3', '2000', '2002'])]

        self.assertEqual(parse_bed_input(stream=bed_file_lines), [('chr1', 1000), ('chr2', 5000), ('chr3', 2000), ('chr3', 2001)])
